    ...
    <>
      ...
      <div className="prose relative mx-auto">
        ...
        <figure className="flex justify-center lg:absolute lg:-left-36 lg:mt-12 lg:flex-none">
          <Image src="/static/images/hexavatar-faruk-shadow.png" width="128" height="138" />
        </figure>
        ...
        <div className="-mx-4 mb-4 flex flex-row justify-between lg:-mx-20 [&>img]:m-0  [&>img]:w-1/6 [&>img]:shadow-lg [&>img]:shadow-stone-400/21 lg:[&>img]:w-36">
